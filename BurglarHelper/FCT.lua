...
function SetTheShortCuts()
	...
	settings.shortcutData_4 = "0x700031F5"; -- diversion
	...
	centerQS4:SetShortcut( Turbine.UI.Lotro.Shortcut( 6, settings.shortcutData_4 ) );
end
------------------------------------------------------------------------------------------
...
function MouseEnterHandler()
	centerQS1.MouseEnter = function(sender, args)
		...
		BurglarHelperWindow.Message:SetForeColor(Turbine.UI.Color.Gold);
	end
	...
	centerQS4.MouseEnter = function(sender, args)
		BurglarHelperWindow.Message:SetText("");
		BurglarHelperWindow.Message:SetText(Strings.PluginBurglarHelper4); 
		BurglarHelperWindow.Message:SetForeColor(Turbine.UI.Color.Gold);
	end

	centerQS1.MouseLeave = function(sender, args)
		BurglarHelperWindow.Message:SetText(Strings.PluginText);
		BurglarHelperWindow.Message:SetForeColor(Turbine.UI.Color.White);
	end
	...
	centerQS4.MouseLeave = function(sender, args)
		BurglarHelperWindow.Message:SetText(Strings.PluginText);
		BurglarHelperWindow.Message:SetForeColor(Turbine.UI.Color.White);
	end
end
