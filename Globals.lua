...
function CreateLocalizationInfo()
	...
	if Turbine.Engine.GetLanguage() == Turbine.Language.German then
		...
		Strings.PluginBurglarHelper4 = "Umleitung";
		...
		Strings.PluginHelp8 = "/Bu toggle - Fenster ein-oder ausblenden\n";
		Strings.PluginHelp9 = "/Bu alt - Aktivieren oder deaktivieren Sie die alt-Taste um das Symbol zu verschieben.\n";
...
elseif Turbine.Engine.GetLanguage() == Turbine.Language.French then
		...
		Strings.PluginBurglarHelper4 = "Diversion";
		...
		Strings.PluginHelp8 = "/Bu toggle - affiche ou cache la fenetre\n";
		Strings.PluginHelp9 = "/Bu alt - Active ou d\195\169sactive la touche alt pour le d\195\169placement de l'icon.\n";
elseif Turbine.Engine.GetLanguage() == Turbine.Language.English then
		...
		Strings.PluginHelp8 = "/Bu toggle - display or hide the window\n";
		Strings.PluginHelp9 = "/Bu alt - Activate or deactivate the alt key to move the icon.\n";
	end
end
